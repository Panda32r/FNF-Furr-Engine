...
--IF YOU ARE NOT USING CERTAIN NAME SLOTS, JUST LEAVE THEM BLANK 
	...
	CoderName1 = 'OG Sonic.EXE mod team'
	CoderName2 = 'Carrot'

	ArtistName1 = 'Hell born assets'	
	ArtistName2  = 'OG Sonic.EXE Team'
	ArtistName3  = 'Cherribun'
	
	MusicianName1 = 'angelkireina'
	MusicianName2 = 'Juno & punkett'
	MusicianName3 = 'MarStarBro'

	CharterName1 = 'angelkireina'
	CharterName2 = 'Carrot'
...
function onCreate()
	...
	--MUSIC TEXT
	makeLuaText('MUSICIANS', 'MUSIC', 1280, HorizontalWordsOffset, -600)
	...
	function onStepHit()
		...
		if curStep == Start then
			...
			doTweenY('ARTIST4', 'ARTIST4', 410, TweenSpeed/1.6, 'QuadOut')
			...
			function onTimerCompleted(tag, loops, loopsLeft)
				...
				if tag == 'ALL THE FUCKING THINGS' then
					...
					doTweenY('ARTIST4EXIT', 'ARTIST4', -1000, TweenSpeed/1.6, 'QuadIn')
