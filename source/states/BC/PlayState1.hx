...
class PlayState extends MusicBeatState
{
	...
	private var strumLineNotes:FlxTypedGroup<StrumNote> = new FlxTypedGroup<StrumNote>();
	private var playerStrums:FlxTypedGroup<StrumNote> = new FlxTypedGroup<StrumNote>();
	private var dadStrums:FlxTypedGroup<StrumNote> = new FlxTypedGroup<StrumNote>();
	...
	{	
		...
		randomTrek=['bopeebo' , 'fresh' , 'sporting'];
		...
		for (i in 0...4)
			{
				...
				var babyArrow:StrumNote = new StrumNote(42, 30, i, player);
